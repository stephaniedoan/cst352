...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=10246640-430c2b46bbce6df2c9971be4f&q=$keyword&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
